...
pacman -Syu realtime-privileges gcc clang pkgconfig cmake make ninja boost llvm qt5-base qt5-imageformats qt5-websockets qt5-quickcontrols2 qt5-serialport qt5-declarative qt5-tools portaudio ffmpeg lv2 suil lilv sdl2 --noconfirm
}
